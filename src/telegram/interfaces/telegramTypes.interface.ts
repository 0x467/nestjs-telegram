...
export interface TelegramMessage {
  ...
  /**
   * _Optional._ Telegram Passport data
   */
...
/**
 * Containts information about Telegram Passport data shared with the bot by the user
 */
...
export interface TelegramEncryptedPassportElement {
  ...
  type:
    ...
    | 'email';
  /**
   * _Optional._ Base64-encoded encrypted Telegram Passport element data provided by the user, available for “personal_details”,
